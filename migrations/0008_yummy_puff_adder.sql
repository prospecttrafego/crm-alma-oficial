...
CREATE INDEX "idx_calendar_events_org_start_time" ON "calendar_events" USING btree ("organization_id","start_time");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_messages_external_id_unique" ON "messages" USING btree ("external_id") WHERE "messages"."external_id" IS NOT NULL;--> statement-breakpoint
